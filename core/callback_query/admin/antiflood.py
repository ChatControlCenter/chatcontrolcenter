...
@set_handler_update(CallbackQueryHandler, r"^antiflood\|set\|(messages|seconds)\|minus$")
...
@on_update(filters=filters.check_role(Role.OWNER, Role.CREATOR, Role.ADMINISTRATOR))
@set_handler_update(CallbackQueryHandler, r"^antiflood\|set\|(messages|seconds)\|plus$")
...
@on_update(filters=filters.check_role(Role.OWNER, Role.CREATOR, Role.ADMINISTRATOR))
@set_handler_update(CallbackQueryHandler, r"^antiflood\|success$")
